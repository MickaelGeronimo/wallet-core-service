...
public class Transaction {
    ...
    public Transaction(String idempotencyKey, Long sourceAccountId, Long targetAccountId, BigDecimal amount, TransactionType type, TransactionStatus status, String description) {
