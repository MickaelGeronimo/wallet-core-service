...
[![Build Status](https://img.shields.io/badge/Tests-17%2F17%20Passing%20(100%25)-success.svg)]()
...
A suíte cobre 17 cenários de estresse, concorrência, integridade contábil, segurança OWASP e injeção de falhas:
```text
[INFO] Tests run: 12, Failures: 0, Errors: 0 -- in ApexWalletApplicationTests
[INFO] Tests run: 5, Failures: 0, Errors: 0 -- in GracefulDegradationStressTest
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS (17/17 testes passando)
[INFO] ------------------------------------------------------------------------
```
